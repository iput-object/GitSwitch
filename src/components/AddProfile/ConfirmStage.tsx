...
import { ArrowLeft, Check, CircleNotch, WarningCircle } from "@phosphor-icons/react";
    ...
    >
      ...
      >
        ...
        <span className="mt-1.5 block text-xs text-neutral-500">
          Pre-filled from your provider. Edit if you commit under a different
          address.
        </span>
      </motion.label>
      ...
      <motion.button
        variants={item}
        onClick={onSave}
        disabled={saving || (!email.trim() && !account.suggestedEmail)}
        whileTap={{ scale: 0.98 }}
